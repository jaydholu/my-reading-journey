...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ['Noto Sans', 'Inter', 'Trebuchet MS', 'Segoe UI', 'Tahoma', 'Verdana', 'system-ui', 'sans-serif'],
      ...
      keyframes: {
        ...
        glow: { '0%, 100%': { boxShadow: '0 0 20px rgba(235, 157, 68, 0.5)' }, '50%': { boxShadow: '0 0 30px rgba(235, 157, 68, 0.8)' } },
